...
function RangeBar({ label, color, progress, optimality, trend }: RangeBarProps) {
  ...
  return (
    <div className="flex justify-end items-center">
      <div className="text-sm opacity-70 w-16 mr-3 text-right">{label}</div>

      <div className="flex w-36 mb-1 relative">
        {progress === undefined ? (
          ...
          <div className="absolute">
            ...
            <div
              ...
              className="bg-background absolute z-50 h-2.5 w-2.5 top-[-.125rem] border-foreground border-[2.5px] rounded-full"
            />

            {/* Bar background */}
            <div className="relative w-36 h-[0.32rem]">
