...
import redBullPh from '../../../assets/images/red-bull-ph.webp';
...
But I noticed that citric acid is listed _above_ taurine on the ingredient list. That's over a gram of citric acid per 8oz can.
...
<Picture
  ...
  alt="A pH test strip showing that Red Bull has a pH between 3 and 4"
  loading="lazy"
  decoding="async"
  class="h-auto w-full"
